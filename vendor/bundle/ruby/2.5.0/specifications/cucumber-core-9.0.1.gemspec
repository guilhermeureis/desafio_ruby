...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cucumber-tag-expressions>.freeze, [">= 3.0.1", "~> 3.0"])
      ...
      s.add_development_dependency(%q<rubocop>.freeze, [">= 1.15.0", "~> 1.15"])
      ...
      s.add_dependency(%q<cucumber-tag-expressions>.freeze, [">= 3.0.1", "~> 3.0"])
      ...
      s.add_dependency(%q<rubocop>.freeze, [">= 1.15.0", "~> 1.15"])
