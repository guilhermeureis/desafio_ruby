...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cucumber-create-meta>.freeze, [">= 4.0.0", "~> 4.0"])
      s.add_runtime_dependency(%q<cucumber-cucumber-expressions>.freeze, [">= 12.1.1", "~> 12.1"])
      s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, [">= 18.1.0", "~> 18.1"])
      s.add_runtime_dependency(%q<cucumber-html-formatter>.freeze, [">= 13.0.0", "~> 13.0"])
      s.add_runtime_dependency(%q<cucumber-messages>.freeze, [">= 15.0.0", "~> 15.0"])
      s.add_runtime_dependency(%q<cucumber-wire>.freeze, [">= 5.0.1", "~> 5.0"])
      ...
      s.add_development_dependency(%q<nokogiri>.freeze, [">= 1.11.4", "~> 1.11"])
      ...
      s.add_development_dependency(%q<test-unit>.freeze, [">= 3.4.1", "~> 3.4"])
      ...
      s.add_dependency(%q<cucumber-create-meta>.freeze, [">= 4.0.0", "~> 4.0"])
      s.add_dependency(%q<cucumber-cucumber-expressions>.freeze, [">= 12.1.1", "~> 12.1"])
      s.add_dependency(%q<cucumber-gherkin>.freeze, [">= 18.1.0", "~> 18.1"])
      s.add_dependency(%q<cucumber-html-formatter>.freeze, [">= 13.0.0", "~> 13.0"])
      s.add_dependency(%q<cucumber-messages>.freeze, [">= 15.0.0", "~> 15.0"])
      s.add_dependency(%q<cucumber-wire>.freeze, [">= 5.0.1", "~> 5.0"])
      ...
      s.add_dependency(%q<nokogiri>.freeze, [">= 1.11.4", "~> 1.11"])
      ...
      s.add_dependency(%q<test-unit>.freeze, [">= 3.4.1", "~> 3.4"])
